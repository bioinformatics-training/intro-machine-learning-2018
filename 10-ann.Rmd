...
```{r echo = F, fig.cap = 'Neuronal computation', fig.align = 'center', fig.show='hold', out.width = '65%'}
knitr::include_graphics(c("images/NN1.png"))
```
...
```{r echo = F, fig.cap = 'Perceptron', fig.align = 'center', fig.show='hold', out.width = '65%'}
knitr::include_graphics(c("images/NN2.png"))
```
...
```{r out.width='100%', fig.asp=1, echo=T}
plot(nn)
```

```{r echo = F, fig.align = 'center', out.width = '100%'}
knitr::include_graphics(c("images/ch07PlotNN.svg"))
```
