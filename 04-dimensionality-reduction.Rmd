...
```{r dimreduc, echo = F, fig.cap = 'Example of a dimensionality reduction. Here we have a what is essentially a two-dimensional dataset embeded in a three dimensional space (swiss roll dataset)', fig.align = 'center', fig.show='hold', out.width = '55%'}
